...
func map_analog_dpad():
	...
	Input.action_press("move_back") if currentForce.y < -0.2 else Input.action_release("move_back")
	Input.action_press("move_forward") if currentForce.y > 0.2 else Input.action_release("move_forward")
